...
export const api = {
  gameservers: {
    ...
    start: (id: string) => post<Gameserver>(`/api/gameservers/${id}/actions/start`),
    stop: (id: string) => post<Gameserver>(`/api/gameservers/${id}/actions/stop`),
    restart: (id: string) => post<Gameserver>(`/api/gameservers/${id}/actions/restart`),
    updateGame: (id: string) => post<Gameserver>(`/api/gameservers/${id}/actions/update-game`),
    reinstall: (id: string) => post<Gameserver>(`/api/gameservers/${id}/actions/reinstall`),
    migrate: (id: string, nodeId: string) => post<Gameserver>(`/api/gameservers/${id}/actions/migrate`, { node_id: nodeId }),
    archive: (id: string) => post<Gameserver>(`/api/gameservers/${id}/actions/archive`),
    unarchive: (id: string, nodeId?: string) => post<Gameserver>(`/api/gameservers/${id}/actions/unarchive`, nodeId ? { node_id: nodeId } : undefined),
    bulk: (action: string, ids: string[]) => post<any>('/api/gameservers/actions/bulk', { action, all: ids.length === 0 }),
    regenerateSftpPassword: (id: string) => post<{ sftp_password: string }>(`/api/gameservers/${id}/actions/regenerate-sftp-password`),
    ...
    command: (id: string, command: string) => post<{ output: string }>(`/api/gameservers/${id}/actions/command`, { command }),
  },
