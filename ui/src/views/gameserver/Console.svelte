<script lang="ts">
  ...
  type LogSeg = { text: string; cls: string };

  function parseLine(line: string): LogSeg[] {
...
<style>
  ...
  /* Prefix: dimmed timestamps, thread names, source info */
  .log-line :global(.log-dim) { color: #5a5550; }

  /* Level keywords in prefix */
  .log-line :global(.log-lvl-info) { color: #6b6560; }
  .log-line :global(.log-lvl-warn) { color: var(--caution); }
  .log-line :global(.log-lvl-error) { color: var(--danger); font-weight: 500; }
  .log-line :global(.log-lvl-debug) { color: #5a5550; }

  /* Message content */
  .log-line :global(.log-msg) { color: var(--text-secondary); }
  .log-line :global(.log-msg-warn) { color: var(--caution); }
  .log-line :global(.log-msg-error) { color: var(--danger); }
  .log-line :global(.log-msg-debug) { color: #7a7570; }
  .log-line :global(.log-chat) { color: var(--text-primary); }
  .log-line :global(.log-join) { color: var(--live); }
  .log-line :global(.log-leave) { color: var(--idle); }
  .log-line :global(.log-system) { color: var(--accent); }
  .log-line :global(.log-trace) { color: var(--danger); opacity: 0.75; }
