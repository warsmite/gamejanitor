      ...
      packages.${system} =
        ...
        in
        {
          default = pkgs.buildGoModule {
            ...
            version = "0.1.0";
            src = ./.;
            vendorHash = "sha256-swp/wosqYyRtJP+pBRlzINM+obkOFzaIhOj9of+6fnE=";
            env.CGO_ENABLED = "0";
      ...
      devShells.${system}.default =
        let
          ...
          update-vendor-hash = pkgs.writeShellScriptBin "update-vendor-hash" ''
            ...
            CURRENT=$(grep -oP '(?<=vendorHash = "sha256-swp/wosqYyRtJP+pBRlzINM+obkOFzaIhOj9of+6fnE="]+' flake.nix | head -1)
